...
Loads results saved by run.py and generates five figures per available tag:
  ...
  plot_06_latent_pca_{tag}.png    — PCA of mapper outputs coloured by each latent dim
