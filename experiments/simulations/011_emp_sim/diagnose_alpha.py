...
def run_diagnostics(agent_path: Path, out_tag: str):
    ...
    add_thumbs(ax2_thumb, top_refs, n_show, zoom=0.28)
    ...
    n_uniform   = 10
    idx_uni     = np.argsort(ratio)[:n_uniform]
    ...
    add_thumbs(ax2u_thumb, uni_refs, n_uniform, zoom=0.28)
